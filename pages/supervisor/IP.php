...
<body>
    ...
    <header class="top-nav">
        ...
        <div class="top-nav-right">
            <span class="role-text">SUPERVISOR / INDUSRY PARTNER</span>
    ...
    <div class="layout-container">
        ...
        <main class="main-content">
            ...
            <div class="stats-row">
                ...
                <div class="stat-card"><span class="stat-label">Completed student Assessment</span><span class="stat-value">3</span></div>
                <div class="stat-card"><span class="stat-label">Incomplete student Assessment</span><span class="stat-value">36</span></div>
                <div class="stat-card"><span class="stat-label">Ongoing student Assessment</span><span class="stat-value">5</span></div>
            </div>
