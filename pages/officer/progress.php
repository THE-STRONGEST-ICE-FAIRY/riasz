...
<head>
    ...
    <title>Progress - RIAS Dashboard</title>
...
<body>
    ...
    <div class="layout-container">
        <aside class="sidebar" id="sidebar">
            ...
            <div class="nav-item active" onclick="window.location.href='progress.php'">
        ...
        <main class="main-content">
            <div class="page-header">
                <div class="date-container">
                    <div class="huge-date">Internship Progress</div>
                </div>
            </div>
            ...
            <div class="panel" style="padding: 30px;">
                ...
                <div style="margin-bottom: 40px;">
                    <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
                        <span style="font-weight: 500; color: #555; font-size: 14px;">Completion Rate across all programs</span>
