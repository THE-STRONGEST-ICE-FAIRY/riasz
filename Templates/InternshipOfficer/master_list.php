            ...
            <div class="panel" style="overflow: visible;">
                ...
                <div id="tab-student" class="tab-content active table-responsive">
                    <table class="master-table">
                        <thead><tr><th>NAME</th><th>COMPANY</th><th>DEPARTMENT</th><th>EMAIL</th></tr></thead>
                        <tbody>
                            <tr><td>John Doe</td><td>TechCorp</td><td>BSIT</td><td>john.doe@student.apc.edu.ph</td></tr>
                            <tr><td>Jane Smith</td><td>Innovate Inc</td><td>BSCS</td><td>jane.s@student.apc.edu.ph</td></tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div id="tab-industry" class="tab-content table-responsive">
                    <table class="master-table">
                        <thead><tr><th>NAME</th><th>COMPANY</th><th>DEPARTMENT</th><th>EMAIL</th></tr></thead>
                        <tbody><tr><td>Mark Johnson</td><td>Creative Studio</td><td>Design</td><td>mark.j@creativestudio.com</td></tr></tbody>
                    </table>
                </div>
                ...
                <div id="tab-exec" class="tab-content table-responsive">
                    <table class="master-table">
                        <thead><tr><th>NAME</th><th>SCHOOL</th><th>PROGRAM</th><th>EMAIL</th></tr></thead>
                        <tbody><tr><td>Dr. Alan Turing</td><td>SoCIT</td><td>Computer Science</td><td>alant@apc.edu.ph</td></tr></tbody>
                    </table>
                </div>
                ...
                <div id="tab-prog" class="tab-content table-responsive">
                    <table class="master-table">
                        <thead><tr><th>NAME</th><th>SCHOOL</th><th>PROGRAM</th><th>EMAIL</th></tr></thead>
                        <tbody><tr><td>Grace Hopper</td><td>SoCIT</td><td>Information Technology</td><td>graceh@apc.edu.ph</td></tr></tbody>
                    </table>
                </div>
                ...
                <div id="tab-officer" class="tab-content table-responsive">
                    <table class="master-table">
                        <thead><tr><th>NAME</th><th>NO OF INTERNS</th><th>EMAIL</th></tr></thead>
                        <tbody>
                            <tr><td>Ada Lovelace</td><td>130</td><td>adal@apc.edu.ph</td></tr>
                            <tr><td>Richard Stallman</td><td>84</td><td>richards@apc.edu.ph</td></tr>
                        </tbody>
                    </table>
                </div>
